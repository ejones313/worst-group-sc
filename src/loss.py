...
class LossComputer(nn.Module):
    def __init__(self, criterion, is_robust, dataset, alpha=None, gamma=0.1, adj=None, step_size=0.01):
    ...
    def loss(self, yhat, y, group_idx=None, pred_outputs = None, aux_outputs = None):
    ...
    def get_model_stats(self, model, args, stats_dict):
        ...
        if isinstance(model, dict):
            stats_dict['model_norm_sq'] = -1
            stats_dict['reg_loss'] = -1
            return stats_dict
